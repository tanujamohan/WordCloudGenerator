<?php
    $lyricsString = printLyrics($_POST['arguments'][0], $_POST['arguments'][1]);
    //echo $_POST['arguments'][1] + $lyricsString;
    $jsonarr = array('track' => $_POST['arguments'][1], 'lyrics' => $lyricsString);
    echo json_encode($jsonarr);  
    //echo "song " + $_POST['arguments'][1] + "is completely printed!!!!!!"; 
    ...
    // printLyrics("Taylor Swift" , "Love Story");
    // echo "\n\n\n";
    // echo "Hello\n";
